                      ...
                      Container(
                        ...
                        child: Align(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/Cursive_Italic_Multipurpse_Typography_Logo_Design_Brand_Identity_Clean_Comic_Style_for_Design_Company_(500__512px)_(1366__768px)_(3).png',
                              width: 273.0,
                              height: 255.0,
                              fit: BoxFit.cover,
                            ),
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          FFAppState()
                                              ...
                                              '+91${_model.phoneNumberTextFieldController.text}';
                                          _model.countSalesmanWIthPhoneNumber =
                                          ...
                                          if (_model
                                                  .countSalesmanWIthPhoneNumber ==
                                              1) {
                                            FFAppState().isSalesmanRegistered =
                                                true;
                                            final phoneNumberVal = FFAppState()
                                                .phoneNumberWithCountryCode;
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: Text('Oops!!'),
                                                  content: Text(
                                                      'Sorry, you are not a member of this organisation.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
